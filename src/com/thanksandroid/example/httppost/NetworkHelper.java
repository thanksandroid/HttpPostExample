...
public class NetworkHelper {
	 ...
	 * @return
	 */
	public static Response doPost(String serviceUrl, String[] keys, String[] values, Context context) {
		...
		try {
			...
			for (int i = 0; i < keys.length; i++) {
				BasicNameValuePair nameValuePair = new BasicNameValuePair(keys[i], values[i]);
